function [cost,varargout] = opt_cost_fun(times, slot_states, plan, t, probs, undodur, nowtime, getplan)
...
for plan_step = 1:numel(action_times)
    ...
    if plan_act > 0
        ...
        cur_cost = late_cost(t, act_time, startprobs, endprobs, binprob, nowtime);
